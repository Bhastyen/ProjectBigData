...
docs <- Corpus(DirSource("data/documents_messages/2018"))
docs
...
head(wf)
barplot(freq[0:50],col=c("#FFCC99", "#FF9933"))
barplot(f[0:15],col=c("#FFCC99", "#FF9933"))
barplot(f[16:30],col=c("#FFCC99", "#FF9933"))
