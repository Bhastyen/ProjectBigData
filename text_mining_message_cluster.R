...
docs <- Corpus(DirSource("data/documents_messages/2017"))
docs
...
head(wf)
barplot(freq[0:50],col=c("chartreuse", "blue4"))
barplot(f[0:15],col=c("chartreuse", "blue4"))
barplot(f[16:30],col=c("chartreuse", "blue4"))
